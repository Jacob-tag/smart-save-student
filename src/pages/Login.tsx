        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          >
            <div className="space-y-1.5">
              ...
              <Input id="email" type="email" placeholder="you@university.ac.za" className="h-12" required />
            </div>
            ...
            <Button type="submit" className="w-full h-12 text-base shadow-glow">
              Sign in
            </Button>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden gradient-primary text-primary-foreground">
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div className="space-y-6 max-w-md">
            <h2 className="font-display font-bold text-4xl xl:text-5xl leading-[1.1]">
              Money clarity, built for student life.
            </h2>
            <p className="opacity-90 text-lg leading-relaxed">
              Track every rand, smash savings goals, and never overspend on takeaways again.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              {[
                ...
                { icon: Wallet, label: "Goal tracking" },
              ].map((f, i) => (
